...
def get_parser(arg_input, arg_opts):
    ...
    parser.add_argument(
        "--output",
        default='output/demo/result.jpg',
...
def opencv_video_format(codec, file_ext):
...
if __name__ == "__main__":
    ...
    # opts = ['train.init_checkpoint=output/dino_r50_4scale_12ep/model_0339999.pth']
    args = get_parser(arg_input=['test.jpg'], arg_opts=['train.init_checkpoint=output/dino_r50_4scale_12ep/model_0339999.pth'])\
        .parse_args()
    ...
    if args.input:
        ...
        codec, file_ext = (
            ("x264", ".mkv") if opencv_video_format("x264", ".mkv") else ("mp4v", ".mp4")
        )
        if codec == ".mp4v":
